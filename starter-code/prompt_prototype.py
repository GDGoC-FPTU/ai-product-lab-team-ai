...
Your task is to draft messaging or dispatcher commands to support EV taxi drivers facing battery depletion.
...
- Instead, you must immediately trigger a Mobile Charging Vehicle dispatch by outputting:
{"action": "dispatch_mobile_charger", "reason": "<explain_why>"}
"""
